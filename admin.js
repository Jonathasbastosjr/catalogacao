...
function preloadIfEditing(){
  ...
  setValue('artwork_id', w.artwork_id); setValue('accession_number', w.accession_number);
...
form.addEventListener('submit', async (e)=>{
  ...
  addWork(work); form.reset(); alert('Obra cadastrada com sucesso! Ela já aparece no catálogo (index).');
});
